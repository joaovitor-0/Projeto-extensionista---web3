...
Área restrita para funcionários da GAVIME, onde é possível consultar e gerenciar os dados do sistema, incluindo atividades, inscritos, voluntários, campanhas, banners e informações de transparência.
